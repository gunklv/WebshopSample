...
using Catalog.IntegrationEventSenderHost.Infrastructure.Integrations.Repositories.Models;
using Dapper;
using Newtonsoft.Json;
using Npgsql;
using System.Data;

namespace Catalog.IntegrationEventSenderHost.Infrastructure.Integrations.Repositories
{
